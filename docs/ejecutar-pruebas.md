...
| ```integrationTest/apiControllersTest```  | de componentes / de API           | java                          | Pruebas de los controladores sin mockear las dependencias. Testean varios componentes desplegados en el container.Mockea la capa de Servicios                                                                                                                                   |
